...
const SEED_BOWLS: Combo[] = [
  {
    ...
    profile: ["cool", "herbal"],
    blend: [
      { brand: "Darkside", line: "Medium", name: "Ultra Nova", percent: 50 },
      { brand: "Darkside", line: "Medium", name: "Needls", percent: 30 },
      { brand: "Darkside", line: "Rare", name: "Basil Blast", percent: 20 },
    ],
  ...
  },
  {
    ...
    profile: ["creamy", "cool"],
    blend: [
      { brand: "Darkside", line: "Medium", name: "Ultra Nova", percent: 40 },
      { brand: "Darkside", line: "Experience", name: "Bana-Nscr", percent: 35 },
      { brand: "Darkside", line: "Soft", name: "Killer Milk", percent: 25 },
    ],
  ...
  },
  {
    ...
    blend: [
      { brand: "Darkside", line: "Medium", name: "Ultra Nova", percent: 40 },
      { brand: "Darkside", line: "Core", name: "Code Pasha", percent: 30 },
      { brand: "Darkside", line: "Soft", name: "Sweetlone", percent: 30 },
    ],
    note: "Cardamom and honey on a stone balcony — afternoon over the old city.",
    session: "afternoon",
  },
  {
    ...
    profile: ["sweet", "nutty"],
    blend: [
      { brand: "Darkside", line: "Medium", name: "Ultra Nova", percent: 45 },
      { brand: "MustHave", line: "125g", name: "Pistachio", percent: 35 },
      { brand: "Darkside", line: "Soft", name: "Sweetlone", percent: 20 },
    ],
