...
export const HOOKAH_COMBOS: HookahCombo[] = [
  {
    ...
    desc: "Cold mint backbone, sharp pine, soft basil finish. The house bowl.",
    ratios: [
  ...
  },
  {
    ...
    ratios: [
      ...
      { pct: "25%", name: "Honey", shelf: { brand: "Darkside", line: "Standard", flavor: "Honey Dust" } },
    ],
    note: "afternoon",
  },
  {
...
// Edit this line before guests arrive.
export const TONIGHT_MUSIC = "tarab"
...
export const SPOTIFY_PLAYLISTS: Record<string, Playlist> = {
  tarab:         { name: "Tarab",          arabic: "طرب",   url: "https://open.spotify.com/playlist/0AT4VdqjlzcSk7NzYBQ0PG" },
  ...
  aghani:        { name: "Aghani",         arabic: "أغاني",  url: "https://open.spotify.com/playlist/4OM70Cv7cFxkTLVqfrpOVi" },
}
